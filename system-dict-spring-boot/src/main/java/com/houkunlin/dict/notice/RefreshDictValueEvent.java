 ...
 * 使用此事件时 {@link DictValue#getDictType()} 字段值为必填项，否则会导致数据更新失败。
 * </p>
 * <p>
 * 此事件支持两种模式：
...
public class RefreshDictValueEvent extends ApplicationEvent {
     ...
     * <p>此值为 false 时不会去维护字典类型里面的值列表数据（使用 {@code com.houkunlin.dict.DictUtil#getDictType(java.lang.String)}、{@code com.houkunlin.dict.DictController#dictType(java.lang.String, java.lang.Integer)}、{@code com.houkunlin.dict.DictController#dictTypeQuery(java.lang.String, java.lang.Integer)}
     * 得到的数据与最新的字典文本不一致）</p>
     *
     * @since 1.4.5
     */
