 ...
 * 字典值序列化器（{@link IDictValueSerializer}）的具体实现类由各版本对应的 Starter 提供。
 * 该接口用于解耦 {@link DictUtil} 与具体版本实现，各版本 Starter 在启动时向 {@link DictUtil} 注册自己的实现。
 * </p>
 *
 * @author HouKunLin
 */
public interface IDictValueSerializerFactory {
    /**
     ...
     */
    IDictValueSerializer getDictTextValueSerializer(Class<?> beanClazz, Field field);
}
