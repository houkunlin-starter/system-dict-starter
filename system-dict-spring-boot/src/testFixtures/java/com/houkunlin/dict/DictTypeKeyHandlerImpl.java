...
public class DictTypeKeyHandlerImpl implements DictTypeKeyHandler<Object> {
    ...
    @Override
    public String getDictText(Object bean, String fieldName, Object value, DictText dictText, String dictType, String arrayItemValue) {
        return DictUtil.getDictText(dictType, arrayItemValue);
    }

    @Override
    public String getDictParentValue(Object bean, String fieldName, Object value, DictText dictText, String dictType, String arrayItemValue) {
