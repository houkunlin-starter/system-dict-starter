...
public interface DictTypeKeyHandler<T> {
     ...
     * @return 字典文本
     */
    String getDictText(final T bean, final String fieldName, final Object value, final DictText dictText, final String dictType, final String arrayItemValue);
     ...
     * @return 父级字典值
     */
    String getDictParentValue(final T bean, final String fieldName, final Object value, final DictText dictText, final String dictType, final String arrayItemValue);
}
