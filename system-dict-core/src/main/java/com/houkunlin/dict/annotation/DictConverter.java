...
/**
 * 系统字典枚举 {@code org.springframework.core.convert.converter.Converter } 转换器生成配置注解。
 * 用于配置系统字典枚举的转换器生成方式，生成的 {@code org.springframework.core.convert.converter.Converter 转换器} 只对 GET 方法参数有效。
 * <p>
