...
public class DictProperties {
    ...
    /**
     * 是否在启动的时候刷新字典；
     * 设置为 true 时在数据量大的时候可能会影响系统启动速度，可在系统启动后发起 {@code com.houkunlin.dict.notice.RefreshDictEvent} 事件通知刷新字典
     *
     ...
     * 此设置只影响 {@code com.houkunlin.dict.notice.RefreshDictEvent} 事件，可以有效避免因频繁触发刷新事件导致的性能问题。
     * </p>
     *
