...
public class DictValue implements Serializable {
    ...
    /**
     * 字典名称，字典值的显示文本。
     * <p>在使用 {@code com.houkunlin.dict.notice.RefreshDictValueEvent} 事件时，此值为 null 意为删除这个字典值文本信息</p>
     */
     ...
     * 并且禁用的字典文本也不会从缓存的字典类型对象中删除，需要在调用 {@code com.houkunlin.dict.notice.RefreshDictTypeEvent} 时明确的把字典文本移除才能从字典类型缓存中删除。
     *
     * @since 1.4.9
     */
