...
import com.houkunlin.dict.jackson2.AbstractDictValueSerializer;
import com.houkunlin.dict.jackson2.DictValueSerializerToArrayImpl;
import com.houkunlin.dict.jackson2.DictValueSerializerToTextImpl;
...
public class DictValueSerializerUtil {
    ...
    /**
     * 构建一个 Map 对象，兼容 Java 8 环境（替代 Map.of 方法）。
     *
     * @param keyValues 键值对参数，按 key1, value1, key2, value2 的顺序排列
     * @return Map 对象
     */
     ...
     */
    public static final DictArray DEFAULT_DICT_ARRAY_TEXT = AnnotationUtils.synthesizeAnnotation(mapOf(
        "split", "",
        "toText", true,
        "delimiter", "、",
